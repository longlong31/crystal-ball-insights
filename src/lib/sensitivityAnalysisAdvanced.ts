...
export const defaultRiskVariables: SensitivityVariable[] = [
  ...
  {
    key: 'electricityPackaging',
    name: 'Chi phí điện & bao bì',
    baseValue: 0.5,
    minValue: 0.3,
    maxValue: 0.8,
    step: 0.1,
...
export const defaultScenarios: ScenarioDefinition[] = [
  {
    name: 'Cơ sở',
    description: 'Kịch bản với các giá trị mặc định',
    changes: {},
  },
  {
    name: 'Lạc quan',
    description: 'Giá bán cao, chi phí thấp, sản lượng tăng',
    changes: {
      basePrice: 13,
      componentCost: 8.5,
      designCapacity: 110000,
      adminCost: 13000,
      inflationRate: 4,
    },
  },
  {
    name: 'Bi quan',
    description: 'Giá bán thấp, chi phí cao, sản lượng giảm',
    changes: {
      basePrice: 11,
      componentCost: 9.5,
      designCapacity: 90000,
      adminCost: 17000,
      inflationRate: 6,
    },
  },
