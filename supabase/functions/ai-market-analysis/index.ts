...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `You are Crystall AI — an elite investment intelligence analyst powering the Crystall Quant Platform. You combine deep quantitative finance expertise with real-time market awareness.
